...
<LINK rel="Bookmark" href="/0.btest/Public/admin/favicon.ico" >
<LINK rel="Shortcut Icon" href="/0.btest/Public/admin/favicon.ico" />
<!--[if lt IE 9]>
<script type="text/javascript" src="/0.btest/Public/admin/frame/lib/html5.js"></script>
<script type="text/javascript" src="/0.btest/Public/admin/frame/lib/respond.min.js"></script>
<script type="text/javascript" src="/0.btest/Public/admin/frame/lib/PIE_IE678.js"></script>
<![endif]-->
<link rel="stylesheet" type="text/css" href="/0.btest/Public/admin/frame/static/h-ui/css/H-ui.min.css" />
<link rel="stylesheet" type="text/css" href="/0.btest/Public/admin/frame/static/h-ui.admin/css/H-ui.admin.css" />
<link rel="stylesheet" type="text/css" href="/0.btest/Public/admin/frame/lib/Hui-iconfont/1.0.7/iconfont.css" />
<link rel="stylesheet" type="text/css" href="/0.btest/Public/admin/frame/lib/icheck/icheck.css" />
<link rel="stylesheet" type="text/css" href="/0.btest/Public/admin/frame/static/h-ui.admin/skin/default/skin.css" id="skin" />
<link rel="stylesheet" type="text/css" href="/0.btest/Public/admin/frame/static/h-ui.admin/css/style.css" />
<link rel="stylesheet" type="text/css" href="/0.btest/Public/admin/frame/style.css" />
<!--[if IE 6]>
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="topfix f-l hidden-xs">
		...
		<div class="container-fluid cl">
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					...
					<li id="Hui-msg">
                        <a href="#" title="消息">
                            <span class="badge badge-danger">88</span><i class="Hui-iconfont" style="font-size:18px">&#xe68a;</i>
                        </a>
                    </li>
                    <!--皮肤-->
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active"><span title="我的桌面" data-href="<?php echo U('Public/index');?>">我的桌面</span><em></em></li>
			</ul>
		</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="<?php echo U('Public/index');?>" style="width: 100%;min-height: 500px;"></iframe>
		</div>
	</div>
</section>
<script type="text/javascript" src="/0.btest/Public/admin/frame/lib/jquery/1.9.1/jquery.min.js"></script>
<script type="text/javascript" src="/0.btest/Public/admin/frame/lib/layer/2.1/layer.js"></script>
<script type="text/javascript" src="/0.btest/Public/admin/frame/static/h-ui/js/H-ui.js"></script>
<script type="text/javascript" src="/0.btest/Public/admin/frame/static/h-ui.admin/js/H-ui.admin.js"></script>
